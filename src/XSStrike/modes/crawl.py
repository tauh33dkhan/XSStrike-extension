                            ...
                            if vectors:
                                for confidence, vects in vectors.items():
                                    try:
                                        ...
                                        print('<h2>[!] Vulnerable webpage: <span class="blue">%s</span></h2>' % (html.escape(url)))
                                        print('<h2>[!] Vector for <span class="purple">%s</span>: <span class="red">%s?%s=%s</span></h2><br/><br/>' % (paramName,html.escape(url), html.escape(paramName), html.escape(payload)))
                                        break
                                    except IndexError:
                                        pass
